...
"""
Determines if a product is at least a specified Version by reading (text) content from a Tag in an XML file at a specific path.
...
Source = '/etc/cma.d/EPOAGENT3700MACX/config.xml'
